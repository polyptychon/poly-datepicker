...
<link rel="stylesheet" href="/node_modules/poly-form-datepicker/_lib/css/poly-form-datepicker.css">
```
...
<script src="/node_modules/poly-form-datepicker/_lib/js/poly-form-datepicker.min.js"></script>
```
...
```html
<link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css">
<link rel="stylesheet" href="/bower_components/poly-form-datepicker/_lib/css/poly-form-datepicker.css">
```
...
<script src="/bower_components/poly-form-datepicker/_lib/js/poly-form-datepicker.min.js"></script>
```
